...
namespace MelisSiteTranslation;


use MelisSiteTranslation\Listener\MelisSiteTranslationFlashMessengerListener;
...
class Module
{
    public function onBootstrap(MvcEvent $e)
    {
        ...
        if ($melisRoute) {
            ...
            $eventManager->attach(new MelisSiteTranslationFlashMessengerListener());
        }
    }
